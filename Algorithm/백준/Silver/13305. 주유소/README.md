...
### 서브태스크
번호:1	배점:17	제한:모든 주유소의 리터당 가격은 1원이다.

 ##### 주유소 리터당 가격 잘못 처리

번호:2	배점:41	제한:2 ≤ N ≤ 1,000, 제일 왼쪽 도시부터 제일 오른쪽 도시까지의 거리는 최대 10,000, 리터 당 가격은 최대 10,000이다.

 ##### 조건 범위 무시

번호:3	배점:42	제한:원래의 제약조건 이외에 아무 제약조건이 없다.
